 ...
 * @typedef {import('./cc-addon-credentials-beta.types.js').CcAddonCredentialsBetaStateLoaded} CcAddonCredentialsBetaStateLoaded
...
defineSmartComponent({
  ...
  onContextUpdate({ context, onEvent, updateComponent }) {
    ...
    function updateNg(newNgInfoOrCallback) {
      updateComponent(
        'state',
        /** @param {CcAddonCredentialsBetaStateLoaded} state */
        (state) => {
